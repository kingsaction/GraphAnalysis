...
public class EdgeEstimation {
	...
	public EdgeEstimation() {
		super();
		// TODO Auto-generated constructor stub
	}
	public EdgeEstimation(String id, String sourceNodeID, String targetNodeID, String sourceNodeName, String targetNodeName,
			Boolean edgeState) {
		super();
		this.id = id;
	...
	public String toString() {
		return "EdgeEstimation [id=" + id + ", sourceNodeID=" + sourceNodeID + ", targetNodeID=" + targetNodeID
