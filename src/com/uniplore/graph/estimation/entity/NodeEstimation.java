...
public class NodeEstimation {
	...
	public NodeEstimation() {
		super();
		// TODO Auto-generated constructor stub
	}
	public NodeEstimation(String id, String nodeName, Integer nodeDegree, Boolean nodeState) {
		super();
		this.id = id;
	...
	public String toString() {
		return "NodeEstimation [id=" + id + ", nodeName=" + nodeName + ", nodeDegree=" + nodeDegree + ", nodeState=" + nodeState
				+ "]";
	}
	public NodeEstimation(String id, String nodeName) {
		super();
		this.id = id;
		this.nodeName = nodeName;
	}
