 ...
 * 项目名称  graphanalysis       
 * 类描述  
 * 类名称    com.uniplore.graph.vectorclustering.EM       
 * 创建人    朱君鹏
 * 创建时间  2017年8月22日 下午9:19:40     
 * 修改人  
 * 修改时间  2017年8月22日 下午9:19:40     
 * 修改备注     
 * @version  1.0      
 */
...
public class EM {
	public static void main(String[] args) throws Exception{
		...
		SphericalGaussianModelFactory smFactory = new SphericalGaussianModelFactory<NumberVector>(init);
		
		
		/**************************************EM聚类****************************************/
		de.lmu.ifi.dbs.elki.algorithm.clustering.em.EM<NumberVector, EMModel> em = new de.lmu.ifi.dbs.elki.algorithm.clustering.em.EM<NumberVector, EMModel>(3, 0.008, smFactory, 5, true);
		// 包含数字向量的关系
		Relation<NumberVector> rel = db.getRelation(TypeUtil.NUMBER_VECTOR_FIELD);
		Clustering<EMModel> c = em.run(db, rel);    //运行EM算法
		...
		// 输出所有的聚类结果
	    int i = 0;
	    for(Cluster<EMModel> clu : c.getAllClusters()) {
